...
@Autonomous(group = "Chimps",name = "CHIMP_B_Clo_Door_Mid")
public class CHIMP_B_Clo_Door_Mid extends LinearOpMode {
    OpenCvCamera webcam;
    ...
    public void runOpMode() throws InterruptedException {
        wBot.init();
        wBot.initForAuton("B_Clo_Door_Mid");
        //wBot.resetSlides();
...
//            telemetry.addData("firstPlacement", firstPlacement);
        ...
        while(opModeIsActive()){
            ...
            sleep(500);
            wBot.perpendicularBoardPlacement(firstBoardSlideAngle, 820);
