...
public class BlueFarPoses {
    ...
    public static double xPosStartingPos = -36 * sideMultiplierX, yPosStartingPos = 63.5 * sideMultipliery, headingStartingPos = Math.toRadians(270);
    public static double xPosStartingPos2 = -36 * sideMultiplierX, yPosStartingPos2 = 53 * sideMultipliery;

    //Purple Pixel Placement
    public static double xPosLeftSpikeMark = -48, yPosLeftSpikeMark = 30 * sideMultipliery, headingLeftSpikeMark = Math.toRadians(0);
    //x=44.5,
    public static double xPosMiddleSpikeMark = -56, yPosMiddleSpikeMark = 23 * sideMultipliery, headingMiddleSpikeMark = Math.toRadians(0);
    public static double xPosRightSpikeMark = -48, yPosRightSpikeMark = 30 * sideMultipliery, headingRightSpikeMark = Math.toRadians(0);
    public static double xPosWhitePickup = -47, yPosWhitePickup = 8 * sideMultipliery, headingWhitePickup= Math.toRadians(180); //???
    ...
    /*
    public static double xPosDoorBoardPlace = 51, yPosDoorBoardPlace = 20 * sideMultipliery, headingLeftDoorBoardPlace = 57; // placeholder; heading will be wrong
    public static double  xPosMidBoardPlace = 51, yPosMidBoardPlace = 20 * sideMultipliery,headingMidDoorBoardPlace = 55;
    public static double  xPosRightBoardPlace = 51, yPosRightBoardPlace = 20 * sideMultipliery, headingRightDoorBoardPlace = 40;
    */
    ...
    public static double PerpendicularBoardPlacementHeading = Math.toRadians(0); //going to be unused
