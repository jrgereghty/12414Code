...
@Autonomous(name = "R_Far_Truss_Edge_REAL")

public class R_Far_Truss_Edge_REAL extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Pose2d startPose = new Pose2d(-35.2, -63.5, Math.toRadians(90.00));
        ...
        Trajectory line4startright = drive.trajectoryBuilder(startPose)
                .lineToSplineHeading(new Pose2d(-36, -53.36, Math.toRadians(60)))//18
        ...
        Trajectory line4start = drive.trajectoryBuilder(startPose)
                .lineToSplineHeading(new Pose2d(-36, -53.36, Math.toRadians(127)))//37
                .addTemporalMarker(0.5, ()-> {
                    slide.setPower(1);
                    slide.setTargetPosition(600);
        ...
        Trajectory pixel2startright = drive.trajectoryBuilder(line4start.end())
                .lineToSplineHeading(new Pose2d(-43, -58.6, Math.toRadians(0)))
                .build();
        ...
        Trajectory start2board = drive.trajectoryBuilder(forward60.end())
                .splineToConstantHeading(new Vector2d(46.01, -37.5), Math.toRadians(0.00))//46.01, 36
                .build();
        ...
        Trajectory strafe2edgeR = drive.trajectoryBuilder(back11.end())
                .lineToSplineHeading(new Pose2d(39, -8, Math.toRadians(180)))
                .build();
...
//_______2222222222-2-2-2-22-2-2-2-2-2-2-2-2-22-2-2-2-22-2-2-2-22-2-2-2-2-2-2-2-2-2-2-2-2-2-2-2-2-2-2-2
            ...
            slideLAngle.setPosition(0.13);
            slideRAngle.setPosition(0.13);
